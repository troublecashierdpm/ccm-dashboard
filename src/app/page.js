          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-6 animate-[fadeIn_0.2s_ease-in-out]">
            <div className="bg-white w-full max-w-xs rounded-[2rem] overflow-hidden shadow-2xl">
              ...
              <div className="p-5 space-y-3">
                <div className="flex justify-between p-3 border rounded-xl bg-white shadow-sm text-xs"><span className="font-bold text-gray-600">Size Large (LA)</span><span className="font-black text-[#e20074]">{activeModalData.data.la}</span></div>
                <div className="flex justify-between p-3 border rounded-xl bg-white shadow-sm text-xs"><span className="font-bold text-gray-600">Size Medium (ME)</span><span className="font-black text-[#e20074]">{activeModalData.data.me}</span></div>
      ...
      <div className="bg-white/80 backdrop-blur-md p-8 rounded-[2.5rem] shadow-[0_15px_35px_-5px_rgba(226,0,116,0.08)] w-full max-w-sm text-center border border-pink-100 relative overflow-hidden">
        ...
        <div className="space-y-4">
          <input 
            ...
            className="w-full pl-5 pr-4 py-4 rounded-2xl bg-gray-50 border border-gray-200 outline-none focus:ring-2 focus:ring-pink-500 transition-all text-sm text-gray-900 font-medium placeholder:text-gray-400" 
          />
          <input 
            type="password" 
