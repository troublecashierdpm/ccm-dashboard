...
export default function App() {
  ...
  // --- LOGIKA MENCATAT LOG LOGIN TETAP BERJALAN ---
          ...
          <div className="min-h-screen bg-[#f8f9fc] font-sans text-[#1a1a1a] pb-12 overflow-x-hidden anim-fade-in relative z-0">
            ...
            <div className="px-5 -mt-12 space-y-4 relative z-20">
              <div className="grid grid-cols-2 gap-4 anim-slide-up">
                <div onClick={() => setDetailType(detailType === 'member' ? null : 'member')} className="glass-card p-6 rounded-[2rem] shadow-lg shadow-pink-500/5 border-b-4 border-b-pink-500 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-pink-500/10 cursor-pointer active:scale-95 group">
                ...
                <div onClick={() => setDetailType(detailType === 'ecobag' ? null : 'ecobag')} className="glass-card p-6 rounded-[2rem] shadow-lg shadow-[#e20074]/5 border-b-4 border-b-[#e20074] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-[#e20074]/10 cursor-pointer active:scale-95 group">
                  <div className="flex justify-between items-start mb-2">
              ...
              <div className="grid grid-cols-4 gap-3 anim-slide-up delay-100">
                <div onClick={() => setDetailType(detailType === 'shortage' ? null : 'shortage')} className="glass-card py-5 rounded-[1.5rem] text-center border-t-[3px] border-t-red-400 cursor-pointer active:scale-90 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-red-500/10 group">
                ...
                <div onClick={() => setDetailType(detailType === 'sp' ? null : 'sp')} className="glass-card py-5 rounded-[1.5rem] text-center border-t-[3px] border-t-orange-400 cursor-pointer active:scale-90 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/10 group">
                ...
                <div onClick={() => setDetailType(detailType === 'sakit' ? null : 'sakit')} className="glass-card py-5 rounded-[1.5rem] text-center border-t-[3px] border-t-blue-400 cursor-pointer active:scale-90 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/10 group">
                ...
                <div className="glass-card py-5 rounded-[1.5rem] text-center border-t-[3px] border-t-purple-400 cursor-default opacity-80">
              ...
              {/* TABEL RANGKUMAN */}
              {detailType && (
                <div className="glass-card p-6 rounded-[2.5rem] mt-6 shadow-xl shadow-gray-200/50 anim-pop-in">
