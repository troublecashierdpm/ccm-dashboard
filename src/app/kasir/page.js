              ...
              <div className="flex items-start gap-5 relative z-10">
                ...
                <div className="flex-1 min-w-0 pt-1">
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    ...
                    <button 
                      onClick={() => fileInputRef.current?.click()}
                      className="bg-white/20 hover:bg-white/30 text-white px-3.5 py-1.5 rounded-xl font-bold text-[10px] uppercase shadow-sm flex items-center gap-1.5 backdrop-blur-sm"
                    >
