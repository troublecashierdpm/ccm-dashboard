...
export async function GET() {
  try {
    ...
    return NextResponse.json({ success: true, message: "Sinkronisasi Bersih Sukses! 🔥" });
  } catch (error) {
